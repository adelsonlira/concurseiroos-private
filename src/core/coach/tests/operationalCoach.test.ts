...
const prescription = {
  id: "p", sessionId: "s", sequence: 1, activity: "teoria" as const, durationMinutes: 40, disciplineId: "d", disciplineName: "D", topicId: "t", topicName: "T", subtopicId: "st", subtopicName: "Sub", actionId: "a", strategicPriority: 1, sourceScore: 1, reasonCode: "FIRST_CONTACT" as never, diagnosticPurpose: false, diagnosticFollowUp: null, whyNow: "x", confidence: "ALTA" as const, objectives: [], executionSteps: [], focusGuide: null, material: null, questionPractice: null, completionEvidence: [], decisionReliability: { level: "HIGH" as const, mode: "FIRST_CONTACT" as const, historicalIncidenceUsed: false, missingData: [], caveats: [] }, executionReadiness: { status: "READY_WITH_FALLBACK" as const, reason: "Use o material principal.", requiredResource: "MATERIAL" as const }, executionGate: { executionStatus: "READY" as const, packet: null, requestedMethod: "teoria", effectiveMethod: "guided_reading", requestedEnvironment: "notebooklm" as const, effectiveEnvironment: "internal_material" as const, methodChanged: true, methodChangeReason: "fallback", blockedReasons: [], materialMatch: "EXACT_TOPIC" as const }, executionPacket: null, nextAction: { afterCompletion: "Registrar.", preview: null },
};
